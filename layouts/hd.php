        ...
        <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                ...
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item mr-auto">
                            ...
                            <a class="navbar-brand" href="<?= base_url() ?>">
                                   <img class="img-responsive" style="display:inline-block; height:80px; margin-top:-20px" src="../../assets/images/logo/logoheader2.jpg" alt="logo" />
            ...
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">                    
                    ...
                    <li class="nav-item <?= (uri() == 'pemesanan/layananv3') ? 'sidebar-group-active':'' ?>">
                        <a class="d-flex align-items-center" href="javascript:;">
                            <i data-feather="shopping-bag"></i>
                            <span class="menu-title text-truncate" data-i18n="Pemesanan">Pemesanan Sosmed</span>
                        </a>
                        <ul class="menu-content">
                            <li class="nav-item <?= (uri() == '/pemesanan/layananv3') ? 'active':'' ?>">
                                <a class="d-flex align-items-center" href="<?= base_url() ?>pemesanan/layananv3">
                                    <i data-feather="layout"></i>
                                    <span class="menu-title" data-i18n="">💎 Social Media</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item <?= (uri() == '/pemesanan/new') ? 'active':'' ?>">
                                <a class="d-flex align-items-center" href="<?= base_url() ?>pemesanan/new">
                                    <i data-feather="layout"></i>
                                    <span class="menu-title" data-i18n="">💎 Social Media 2</span>
                                </a>
                            </li>
                        ...
                        <ul class="menu-content">
                            <li class="nav-item <?= (uri() == '/deposit/new') ? 'active':'' ?>">
                                <a class="d-flex align-items-center" href="<?= base_url() ?>deposit/new">
                                    <i data-feather="circle"></i>
                                    <span class="menu-title" data-i18n="Kelola">Deposit Saldo</span>
                                </a>
                            </li>
                            <li class="nav-item <?= (uri() == '/deposit/adminwa') ? 'active':'' ?>">
                                <a class="d-flex align-items-center" href="<?= base_url() ?>deposit/adminwa">
                                    <i data-feather="circle"></i>
                                    <span class="menu-title" data-i18n="Deposit Voucher">Beli Voucher</span>
                                </a>
                            </li>
                            <li class="nav-item <?= (uri() == '/deposit/voucher') ? 'active':'' ?>">
                                <a class="d-flex align-items-center" href="<?= base_url() ?>deposit/voucher">
                                    <i data-feather="circle"></i>
                                    <span class="menu-title" data-i18n="Voucher">Redeem Voucher</span>
                                </a>
                            </li>
