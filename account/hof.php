...
$top_layanan = $db->query("SELECT SUM(pembelian_sosmed.harga) AS tamount, count(pembelian_sosmed.id) AS tcount, pembelian_sosmed.layanan, layanan_sosmed.layanan FROM pembelian_sosmed JOIN layanan_sosmed ON pembelian_sosmed.layanan, layanan_sosmed.layanan FROM pembelian_sosmed2 JOIN layanan_sosmed ON pembelian_sosmed.layanan, layanan_sosmed.layanan FROM pembelian_sosmed3 JOIN layanan_sosmed ON pembelian_sosmed.layanan = layanan_sosmed.layanan WHERE pembelian_sosmed.status = 'Success' GROUP BY pembelian_sosmed.layanan ORDER BY tamount DESC LIMIT 10");
