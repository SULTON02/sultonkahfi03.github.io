...
$total_data_completed = mysqli_num_rows($db->query("SELECT * FROM pembelian_sosmed WHERE status = 'Completed'"));
$total_data_error = mysqli_num_rows($db->query("SELECT * FROM pembelian_sosmed WHERE status IN ('Error','Canceled','Partial')"));
//END TO DATA
      ...
      <div class="card">
        <div class="card-header">
          <div>
            ...
            <p class="card-text">Error & Partial & Canceled</p>
          </div>
