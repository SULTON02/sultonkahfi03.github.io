...
require_once '../lannsistem.app/auth-login.php'; ?>
...
<head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?= asset('/images/border/ya.jpg') ?>" />
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <h4 class="card-title mb-1">Welcome to <b><?= $web['NamaWeb']; ?></b> 👋</h4>
                                <p class="card-text mb-2">Silahkan masuk menggunakan akun Anda.</p>
                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdown-flag"><li><span style="color: rgba(231, 22, 22, 1)"><span style="text-align: CENTER"><u style="text-decoration: underline"><strong style="font-weight: bold"><b><a class="dropdown-item" href="../halaman/web_panel">Ingin Punya Web Seperti RAJAPANELL?</a></b></strong></u></span></li></div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group form-password-toggle">
                                                    <input type="password" class="form-control" name="pass" id="user-name" placeholder="Password">
                                      ...
                                      <div class="g-recaptcha" data-sitekey="<?= $_CONFIG['reCaptcha']['sitekey']; ?>"></div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <button type="submit" name="login" class="btn btn-primary btn-block btn-inline">Masuk</button>
                                            </div>
                                        </div>
                                    </div>
