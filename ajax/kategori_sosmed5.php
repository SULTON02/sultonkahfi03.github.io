...
if (isset($_POST['category'])) {
	...
	$data = $db->query("SELECT * FROM kategori_layanan5 ORDER BY nama ASC");	
...
function type($a, $i) {
	...
	$query = $db->query("SELECT * FROM kategori_layanan5 WHERE kode = '". type($post_kategori, $cek['kode']) ."' ORDER BY kode ASC");	
	?>	
