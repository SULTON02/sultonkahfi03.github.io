...
function status($s) {
    if ($s === "Success") {
        ...
        return '<div class="badge badge-light-success">><i class="far fa-check-circle"></i> Completed</div>';
    } else if ($s === "Pending") {
        return '<div class="badge badge-warning"><i class="mdi mdi-autorenew mdi-spin"></i> Pending</div>';
    } else if ($s === "In progress") {
        return '<div class="badge badge-info"><i class="mdi mdi-cube-send"></i> In progress</div>';
        ...
        return '<div class="badge badge-danger"><i class="far fa-times-circle"></i> Canceled</div>';
    } else {
